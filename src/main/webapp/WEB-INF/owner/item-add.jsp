                    ...
                    <main class="my-3 ">
                        ...
                        <!--<div class="row">-->
                            <div class="card p-3 mr-3">
                                <form th:action="@{/saveItem}" th:object="${item}" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-6">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td colspan="3">
                                                            ...
                                                            <input type="hidden" th:field-"*{itemAvailability}" name="itemAvailability" value="Available" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><label for="Image" class="form-label">Image 1</label>
                                                        ...
                                                        <img id="frame1" src="" class="img-fluid" height="30%"/>
                                                    </td>
                                                    ...
                                                    <td><label for="Image" class="form-label">Image 3</label>
                                                        ...
                                                        <img id="frame3" src="" class="img-fluid" height="30%"/>
                                                    </td> 
                                                </tr>
                                            </tbody>
                                        </table>
